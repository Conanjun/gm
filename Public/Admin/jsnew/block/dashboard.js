...
{
	var url="index.php?s=Admin/index/delete.html&id="+index;
...
function sortBlocks(orders)
{
    ...
    var url="index.php?s=Admin/index/sort.html&orders="+newOrders.join(',');
    $.getJSON(url, function(data)
    {
...
function resizeBlock(event)
{
    ...
    var url="index.php?s=Admin/index/resize.html&id="+blockID+"&type="+event.type + '&data=' + data;
    $.getJSON(url, function(data)
    {
