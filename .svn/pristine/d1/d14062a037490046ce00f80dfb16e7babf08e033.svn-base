...
class Dispatcher {
    ...
    static public function dispatch() {
        ...
        if( MODULE_NAME && (!in_array_case(MODULE_NAME,C('MODULE_DENY_LIST')) || $domainModule ) && is_dir(APP_PATH.MODULE_NAME)){
            ...
            // 加载模块配置文件
            if(is_file(MODULE_PATH.'Conf/config.php')||MODULE_PATH=='../Application/Admin/'||MODULE_PATH=='../Application/Studio/'||MODULE_PATH=='../Application/Dentist/')
            	if(MODULE_PATH=='../Application/Admin/'||MODULE_PATH=='../Application/Studio/'||MODULE_PATH=='../Application/Dentist/'){
            		C(require C('CONFIG_PATH'));
            	}else{
