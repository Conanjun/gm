...
/*!
 * ZUI: zui for zentao - v1.6.0 - 2017-05-11
 * http://zui.sexy
...
function(c, d) {
    ...
    c.zui || (c.zui = function(a) {
        c.isPlainObject(a) && c.extend(c.zui, a)
    });
    var b = 0;
    c.zui({
        uuid: function() {
            return 1000 * (new Date).getTime() + b++%1000
        },
        callEvent: function(h, f, g) {
            if (c.isFunction(h)) {
                void 0 !== g && (h = c.proxy(h, g));
                var j = h(f);
                return f && (f.result = j),
                !(void 0 !== j && !j)
            }
        ...
        clientLang: function() {
            var e, f = d.config;
            if ("undefined" != typeof f && f.clientLang && (e = f.clientLang), !e) {
                var g = c("html").attr("lang");
    ...
    c.fn.callEvent = function(m, g, h) {
        var p = c(this),
        q = m.indexOf(".zui."),
        j = q < 0 ? m: m.substring(0, q),
        k = c.Event(j, g);
        if (void 0 === h && q > 0 && (h = p.data(m.substring(q + 1))), h && h.options) {
            var f = h.options[j];
            c.isFunction(f) && c.zui.callEvent(f, k, h)
        }
        return p.trigger(k),
        k
    }
...
/*!
 * ZUI: Generated from less code - v1.6.0 - 2017-05-11
 * http://zui.sexy
 * GitHub: https://github.com/easysoft/zui.git 
 * Copyright (c) 2017 cnezsoft.com; Licensed MIT
 */
...
function(d, g, b) {
    ...
    f.prototype.init = function() {
        var Z, aa, U, W, ac, ai, aj, Y, af, ah, N, ag, M, ab = this,
        ak = ab.$,
        I = ab.options,
        K = I.deviation,
        V = "." + c + "." + ab.id,
        ...
        R = ak,
        G = !1,
        F = e ? d(I.container).first() : a ? ak: d("body"),
        X = function(o) {
            if (G && (N = {
                left: o.pageX,
                top: o.pageY
            },
            !(b.abs(N.left - Y.left) < K && b.abs(N.top - Y.top) < K))) {
                if (null === U) {
                    var n = F.css("position");
                    "absolute" != n && "relative" != n && "fixed" != n && (ai = n, F.css("position", "relative")),
                    U = R.clone().removeClass("drag-from").addClass("drag-shadow").css({
                        position: "absolute",
                        width: R.outerWidth(),
                        transition: "none"
                    }).appendTo(F),
                ...
                if (Z.each(function() {
                    ...
                    v = x.outerWidth(),
                    y = x.outerHeight(),
                    z = u.left + I.sensorOffsetX,
                    w = u.top + I.sensorOffsetY;
                    if (N.left > z && N.top > w && N.left < z + v && N.top < w + y && (p && p.removeClass("drop-to"), p = x, !I.nested)) {
                        return ! 1
                    }
                }), p) {
                    W = !0;
                    var k = p.data("id");
                    R.data("id") != k && (ac = !1),
                    (null === aa || aa.data("id") !== k && !ac) && (l = !0),
                    aa = p,
                    H && Z.removeClass("drop-to"),
                    aa.addClass("drop-to")
                }
                H ? null !== aa && aa.length && (W = !0) : (R.toggleClass("drop-in", W), U.toggleClass("drop-in", W)),
                ab.trigger("drag", {
                    event: o,
                    isIn: W,
                    target: aa,
        ...
        B = function(l) {
            if (d(g).off(V), clearTimeout(M), G) {
                if (G = !1, ai && F.css("position", ai), null === U) {
                    return R.removeClass("drag-from"),
                    void ab.trigger("always", {
                        event: l,
                        cancel: !0
                    })
                }
                ...
                m = ab.trigger("beforeDrop", k),
                m && W && ab.trigger("drop", k),
                Z.removeClass("drop-to"),
                R.removeClass("dragging").removeClass("drag-from"),
                U.remove(),
                U = null,
                ab.trigger("finish", k),
                ab.trigger("always", k),
        ...
        ae = function(k) {
            var l = d(this);
            a && (R = Q ? l.closest(a) : l),
            R.hasClass("drag-shadow") || I.before && I.before({
                event: k,
                element: R
            }) === !1 || (G = !0, Z = d.isFunction(I.target) ? I.target(ak) : F.find(I.target), aa = null, U = null, W = !1, ac = !0, ai = null, aj = R.offset(), af = F.offset(), Y = {
                left: k.pageX,
                top: k.pageY
            },
            ag = d.extend({},
            ...
            R.addClass("drag-from"), d(g).on(ad, X).on(q, B), M = setTimeout(function() {
                d(g).on(J, B)
            },
            10), k.preventDefault())
        };
        Q ? ak.on(J, Q, ae) : a ? ak.on(J, a, ae) : ak.on(J, ae)
    },
...
function(d, f) {
    ...
    h.prototype.init = function() {
        ...
        a = function(n) {
            ...
            G = {
                x: n.pageX - o.left + F.left,
                y: n.pageY - o.top + F.top
            },
            A = d.extend({},
            J),
            D = !1,
...
function(d, h, b) {
        ...
        function(N) {
            function R(x) {
                ...
                a.children(":not(.dragging-col)").each(function() {
                    ...
                    if (u.sensitive) {
                        E -= l.left,
                        X -= l.top,
                        z = k(U, H, P, W, E, X, E + C, X + D),
                        z > 100 && z > w && z > h.min(c(U, H, P, W), c(E, X, E + C, X + D)) / 3 && (w = z, G = Y)
                    } else {
                        var S = x.pageX,
                        T = x.pageY;
                        if (S > E && T > X && S < E + C && T < X + D) {
                            return G = Y,
                            !1
                        }
                    }
            ...
            function I(x) {
                ...
                a.children(":not(.dragging-col-holder)").each(function() {
                    ...
                    C.data("order", ++y),
                    z[C.data("id") || C.attr("id")] = y,
                    C.parent().attr("data-order", y)
                }),
            ...
            J.css({
                ...
                x: N.pageX - A.left + l.left,
                y: N.pageY - A.top + l.top
            }),
            n && (J.addClass("circle"), setTimeout(function() {
                J.css({
                    left: N.pageX - l.left - e,
                    top: N.pageY - l.top - e,
                    width: p,
                    height: p
                }).data("mouseOffset", {
    ...
    g.prototype.init = function() {
        ...
        if (a.id = l.id ? l.id: a.$.attr("id"), l.data) {
            ...
            d.each(l.data,
            function(v, o) {
                var w = d('<div class="col-sm-' + (o.colWidth || 4) + '"/>', o.colAttrs),
                q = d('<div class="panel" data-id="' + (o.id || d.zui.uuid()) + '"/>', o.panelAttrs);
                if (o.height !== b && q.data("height", o.height), o.content !== b) {
...
function(w, m, v) {
    ...
    b = function(z, o) {
        ...
        o.contentClass && s.addClass(o.cssClass),
...
function(d) {
    ...
    b.prototype._init = function() {
        ...
        o = function(e) {
            ...
            if (!P.altKey && 3 !== e.which && P.callEvent("start", e) !== !1) {
                var h = P.$children = P.$.find(O.selector);
                h.addClass("slectable-item");
                var a = P.multiKey ? "multi": O.clickBehavior;
                if ("multi" === a ? P.toggle(e.target) : "single" === a ? (P.unselect(), P.select(e.target)) : "toggle" === a && P.toggle(e.target, null,
                function(l) {
                    P.unselect()
                }), P.callEvent("startDrag", e) === !1) {
...
function(d) {
    ...
    c.prototype.render = function() {
        ...
        var B;
        ag.fixedLeft && (B = d(af), B.addClass("fixed-left").find("table").addClass(aa.tableClass).append(aj), j.append(B)),
        ag.flexArea && (B = d(af), B.addClass("flexarea").find(".datatable-wrapper").append('<div class="scrolled-shadow scrolled-in-shadow"></div><div class="scrolled-shadow scrolled-out-shadow"></div>').find("table").addClass(aa.tableClass).append(Y), j.append(B)),
        ag.fixedRight && (B = d(af), B.addClass("fixed-right").find("table").addClass(aa.tableClass).append(X), j.append(B)),
        U.append(j),
        ag.flexArea && U.append('<div class="scroll-wrapper"><div class="scroll-slide scroll-pos-' + aa.scrollPos + '"><div class="bar"></div></div></div>');
        var V = U.children(".datatable-footer").detach();
        ag.footer ? (U.append(d('<div class="datatable-footer"/>').append(ag.footer)), ag.footer = null) : V.length && U.append(V),
    ...
    c.prototype.bindEvents = function() {
        ...
        if (ax.flexArea) {
            ...
            var ah = function(g, h) {
                ...
                aq.storage && b.pageSet(ac, aE)
            },
            G = function() {
                am = aj.width(),
                ae.width(am).css("left", ag.width()),
                al = av.width(),
                az = Math.floor(am * am / al),
                B.css("width", az),
                av.css("min-width", am),
                ar.toggleClass("show-scroll-slide", al > am),
                ai || am === az || (ai = !0, ah(b.pageGet(ac, 0), !0)),
            ...
            var ad = {
                ...
                stopPropagation: !0,
                drag: function(e) {
                    ah(B.position().left + e.smallOffset.x * (e.element.hasClass("bar") ? 1 : -1))
                },
                finish: function() {
                    ar.removeClass("scrolling")
                }
            };
            d.fn.draggable ? (B.draggable(ad), aq.flexHeadDrag && ar.find(".datatable-head-span.flexarea").draggable(ad)) : console.error("DataTable requires draggable.js to improve UI."),
            ae.mousedown(function(g) {
                var h = g.pageX - ae.offset().left;
                ah(h - az / 2)
            })
        }
        if (aq.checkable) {
            var X, Q = aB.id + "_checkedStatus",
            af = aq.checkedClass,
            K = function() {
            ...
            aw = function(j, g) {
                ...
                void 0 === g && (g = !h.hasClass(af)),
                ap.filter('[data-index="' + h.data("index") + '"]').toggleClass(af, !!g)
            },
            V = "click.zui.datatable.check";
            if (aq.selectable) {
                var ab = {
                ...
                d.isPlainObject(aq.selectable) && d.extend(ab, aq.selectable),
                this.$datatable.selectable(ab)
            } else {
                this.$rowsSpans.off(V).on(V + "row", aq.checkByClickRow ? "tr": ".check-row",
                function() {
                    aw(this),
                    K()
                })
            }
            if (this.$datatable.off(V).on("click.zui.datatable.check", ".check-all",
            function() {
                ap.toggleClass(af, d(this).toggleClass("checked").hasClass("checked")),
                K()
            }).on(V + ".none", ".check-none",
            function() {
                ap.toggleClass(af, !1),
                K()
            }).on(V + ".inverse", ".check-inverse",
            function() {
                ap.toggleClass(af),
                K()
            }), aq.storage) {
                var Z = b.pageGet(Q);
                Z && (au.find(".check-all").toggleClass("checked", Z.checkedAll), Z.checkedAll ? ap.addClass(af) : (ap.removeClass(af), d.each(Z.checks,
                function(g, h) {
                    ap.filter('[data-id="' + h + '"]').addClass(af)
                })), Z.checks.length && K())
            }
        }
        if (aq.fixedHeader) {
            var U, J, aa, q = ar.children(".datatable-head"),
            aF = aq.fixedHeaderOffset || d(".navbar.navbar-fixed-top").height() || 0,
            a = function() {
                U = ar.offset().top,
                aa = d(window).scrollTop(),
                J = ar.height(),
                ar.toggleClass("head-fixed", aa + aF > U && aa + aF < U + J),
                ar.hasClass("head-fixed") ? q.css({
                    width: ar.width(),
                    top: aF
                }) : q.attr("style", "")
            };
...
function createLink(d, b, e, a, c) {
    ...
    if ((typeof(config.onlybody) != "undefined" && config.onlybody == "yes") || c) {
        var f = config.requestType != "GET" ? "?onlybody=yes": "&onlybody=yes";
        link = link + f
    }
    return link
}
...
function adjustOuterSize() {
    ...
    $("#wrap .outer .side").parent().css("min-height", a);
}
...
function setForm() {
    ...
    $("form").submit(function() {
        ...
        if ($(submitObj).size() >= 1) {
            ...
            var b = submitObj.attr("data-submitting") || '稍等...';
            if (c) {
                submitObj.text(b)
            } else {
...
function setFormAction(b, c, e) {
    $form = typeof(e) == "undefined" ? $("form") : $(e).closest("form");
    if (c) {
        $form.attr("target", c)
    } else {
    ...
    $form.attr("action", b);
    var a = navigator.userAgent.indexOf("AppleWebKit") > -1;
    if (a) {
        var d = "checkbox-fix-" + $.zui.uuid();
        $form.find('input[type="checkbox"]').each(function() {
            var f = $(this);
            var g = d + f.val();
            f.attr("data-fix-checkbox", g).after('<div id="' + g + '"/>').appendTo($form)
        })
    }
    $form.submit();
    if (a) {
        $form.find("[data-fix-checkbox]").each(function() {
            var f = $(this);
            $("#" + f.data("fixCheckbox")).after(f).remove()
        })
    }
}
    ...
    jQuery.fn.modalTrigger = function(e) {
        return $(this).each(function() {
            ...
            function(m) {
                ...
                var param  = (e ? e.param : false) || j.data('param');
    ...
    function b(h, k, g, j) {
        ...
        try {
            ...
            if (h.height == "auto") {
                ...
                setTimeout(function() {
                    k.removeClass("fade");
                    var e = l.addClass("body-modal").outerHeight();
...
function fixedTfootAction(a) {
    ...
    function l() {
        f = j.width();
        c = g.hasClass("fixedTfootAction");
        offsetHeight = $(window).height() + $(window).scrollTop() - h / 2;
        m = b.offset().top + b.height() + g.height();
        if (!c && offsetHeight <= m) {
            g.addClass("fixedTfootAction").width(f).find("td").width(f);
            if (k.size() > 0) {
                k.width(k.width())
            }
        }
        if (c && (offsetHeight > m || $(document).height() == offsetHeight)) {
            g.removeClass("fixedTfootAction").removeAttr("style").find("td").removeAttr("style")
        }
    }
    function e() {
...
function fixedTheadOfList(d) {
    ...
    function g() {
        ...
        if (a.size() <= 0 && f < $(window).scrollTop()) {
            ...
            $(d).before(c);
            $(d).prev().addClass($(d).attr("class")).width(b)
        }
        if (a.size() > 0 && f >= $(window).scrollTop()) {
            a.remove()
        }
...
(function() {
    ...
    a = function() {
        ...
        h.prototype.add_group = function(u) {
            ...
            }), m = u.childNodes, w = [], q = 0, v = m.length; v > q; q++) {
                l = m[q],
        ...
        h.prototype.add_option = function(n, m, l) {
            return "OPTION" === n.nodeName.toUpperCase() ? ("" !== n.text ? (null != m && (this.parsed[m].children += 1), this.parsed.push({
    ...
    a.select_to_array = function(l) {
        var q, n, p, u, m;
        for (n = new a, m = l.childNodes, p = 0, u = m.length; u > p; p++) {
            q = m[p],
            n.add_node(q)
        }
        return n.parsed
    ...
    g = function() {
        ...
        h.prototype.results_option_build = function(m) {
            var q, n, l, p, u;
            for (q = "", u = this.results_data, l = 0, p = u.length; p > l; l++) {
                n = u[l],
        ...
        h.prototype.reset_single_select_options = function() {
            var m, p, n, l, o;
            for (l = this.results_data, o = [], p = 0, n = l.length; n > p; p++) {
                m = l[p],
        ...
        h.prototype.winnow_results = function(E) {
            ...
            for (this.no_results_clear(), p = 0, q = this.get_search_text(), y = q.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), m = this.search_contains ? "": "^", w = new RegExp(m + y, "i"), B = new RegExp(y, "i"), z = this.results_data, C = 0, D = z.length; D > C; C++) {
                F = z[C],
                F.search_match = !1,
                x = null,
            ...
            1 > p && q.length ? (this.update_results_content(""), this.no_results(q)) : (this.update_results_content(this.results_option_build()), this.winnow_results_set_highlight(E))
        },
        ...
        h.prototype.choices_count = function() {
            ...
            for (this.selected_option_count = 0, l = this.form_field.options, o = 0, n = l.length; n > o; o++) {
                m = l[o],
        ...
        h.prototype.keyup_checker = function(l,u) {
            var n, m;
    ...
    d = function(l) {
        ...
        h.prototype.container_mousedown = function(m) {
            return this.is_disabled || (m && "mousedown" === m.type && !this.results_showing && m.preventDefault(), null != m && b(m.target).hasClass("search-choice-close")) ? void 0 : (this.active_field ? this.is_multiple || !m || b(m.target)[0] !== this.selected_item[0] && !b(m.target).parents("a.chosen-single").length || (m.preventDefault(), this.results_toggle()) : (this.is_multiple && this.search_field.val(""), b(this.container[0].ownerDocument).bind("click.chosen", this.click_test_action), this.results_show()), this.activate_field())
        },
        ...
        h.prototype.search_results_mousewheel = function(m) {
            var n;
            return m.originalEvent && (n = -m.originalEvent.wheelDelta || m.originalEvent.detail),
            null != n ? (m.preventDefault(), "DOMMouseScroll" === m.type && (n = 40 * n), this.search_results.scrollTop(n + this.search_results.scrollTop())) : void 0
        },
        ...
        h.prototype.result_do_highlight = function(y, x) {
            var z, v, m, p, w, q, u = -1;
            y.length && (this.result_clear_highlight(), this.result_highlight = y, this.result_highlight.addClass("highlighted"), m = parseInt(this.search_results.css("maxHeight"), 10), q = this.result_highlight.outerHeight(), w = this.search_results.scrollTop(), p = m + w, v = this.result_highlight.position().top + this.search_results.scrollTop(), z = v + q, this.middle_highlight && (x || "always" === this.middle_highlight || z >= p || w > v) ? u = Math.min(v - q, Math.max(0, v - (m - q) / 2)) : z >= p ? u = z - m > 0 ? z - m: 0 : w > v && (u = v), u > -1 && this.search_results.scrollTop(u))
        },
        ...
        h.prototype.set_tab_index = function(m) {
            var n;
            return this.form_field.tabIndex ? (n = this.form_field.tabIndex, this.form_field.tabIndex = -1, this.search_field[0].tabIndex = n) : void 0
        },
        h.prototype.set_label_behavior = function() {
            var m = this;
            return this.form_field_label = this.form_field_jq.parents("label"),
            !this.form_field_label.length && this.form_field.id.length && (this.form_field_label = b("label[for='" + this.form_field.id + "']")),
        ...
        h.prototype.search_results_mouseup = function(n) {
            var m;
            return m = b(n.target).hasClass("active-result") ? b(n.target) : b(n.target).parents(".active-result").first(),
            m.length ? (this.result_highlight = m, this.result_select(n), this.search_field.focus()) : void 0
        },
        h.prototype.search_results_mouseover = function(n) {
            var m;
            return m = b(n.target).hasClass("active-result") ? b(n.target) : b(n.target).parents(".active-result").first(),
            m ? this.result_do_highlight(m) : void 0
        },
        h.prototype.search_results_mouseout = function(m) {
            return b(m.target).hasClass("active-result") ? this.result_clear_highlight() : void 0
        },
        ...
        h.prototype.choice_destroy_link_click = function(m) {
            ...
            m.stopPropagation(),
            this.is_disabled ? void 0 : this.choice_destroy(b(m.target))
        },
        ...
        h.prototype.result_select = function(m) {
            var o, n;
            return this.result_highlight ? (o = this.result_highlight, this.result_clear_highlight(), this.is_multiple && this.max_selected_options <= this.choices_count() ? (this.form_field_jq.trigger("chosen:maxselected", {
                chosen: this
        ...
        h.prototype.result_deselect = function(m) {
            ...
            this.form_field.options[n.options_index].disabled ? !1 : (n.selected = !1, this.form_field.options[n.options_index].selected = !1, this.selected_option_count = null, this.result_clear_highlight(), this.results_showing && this.winnow_results(), this.form_field_jq.trigger("change", {
        ...
        h.prototype.winnow_results_set_highlight = function(m) {
            ...
            o = n.length ? n.first() : this.search_results.find(".active-result").first(),
            null != o ? this.result_do_highlight(o, m) : void 0
        },
        ...
        h.prototype.search_field_scale = function() {
            ...
            if (this.is_multiple) {
                for (v = 0, q = 0, p = "position:absolute; left: -1000px; top: -1000px; display:none;", w = ["font-size", "font-style", "font-weight", "font-family", "line-height", "text-transform", "letter-spacing"], u = 0, y = w.length; y > u; u++) {
                    m = w[u],
