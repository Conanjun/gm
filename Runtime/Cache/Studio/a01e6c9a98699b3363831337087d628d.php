            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5><?php echo L('STUDIO_TASK_SW');?></h5>
                    </div>
                                    ...
                                    <table id="tt_1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($filtered != 0): ?><a href="<?php echo U('OrderTaskSw/index');?>" class="btn btn-default"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                ...
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <?php if($vo["task_state"] == 0): ?><a href="javascript:void(0);"  onclick="reply(<?php echo ($vo['tastkid']); ?>,<?php echo ($vo['oid']); ?>)"  data-width="800" data-height="600" class="btn btn-primary"><?php echo L('FINISH_HANDEL');?></a><?php endif; ?>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="<?php echo U('OrderTaskSw/confirm');?>" class="form-horizontal" id="task_form" method='post' enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea id="finishnote"  name="finishnote" class="form-control" style="width: 400px;height: 170px;"></textarea>
                                                </div>
                                            </div>
