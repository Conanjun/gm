                    ...
                    <div class="ibox-content">
                        ...
                        <form action="" method='post' id="form" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('SENDER');?></label>
                                <div class="col-sm-3">
                                    <p class="form-control-static"><?php echo ($list['nickname']); ?></p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('RECIPIENT');?></label>
                                <div class="col-sm-3">
                                    <p class="form-control-static"><?php echo ($list['mname']); ?></p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('THEME');?></label>
                                <div id="region" class="col-sm-10">
                                	<?php switch($list['outtype']): case "client_order": ?><a href="<?php echo U('PlatOrder/view?id='.$list['outkey']);?>"><p class="form-control-static"><?php echo ($list['title']); ?></p></a><?php break;?>
										<?php case "studio_dept": ?><a href="<?php echo U('PlatOrder/view?id='.$list['outkey']);?>"><p class="form-control-static"><?php echo ($list['title']); ?></p></a><?php break;?>
										<?php case "feed_back": ?><a href="<?php echo U('Feedback/view?id='.$list['outkey']);?>"><p class="form-control-static"><?php echo ($list['title']); ?></p></a><?php break;?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('CONTENT');?></label>
                                <div class="col-sm-3">
                                    <p class="form-control-static"><?php echo ($list['content']); ?></p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('IS_READ');?></label>
                                <div class="col-sm-10">
                                    <?php if($list["isread"] == 1): echo L('YES'); endif; ?>
                                    <?php if($list["isread"] == 0): echo L('NO'); endif; ?>
                                </div>
                            </div>


                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('ADDTIME');?></label>
                                <div class="col-sm-10">
                                   <?php if($list["addtime"] != 0): echo (date("Y-m-d H:i:s",$list['addtime'])); endif; ?>
                                </div>
                            </div>
                        </form>
                    </div>
