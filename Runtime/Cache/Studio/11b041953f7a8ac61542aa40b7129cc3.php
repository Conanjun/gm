            ...
            $('#form').validate({
                ...
                rules: {
                    name: {
                        required: true,
                        remote: {
                            url: "<?php echo U('Dentist/check_name');?>",
                            type: 'post',
                            data: {
                                name: function () {
                                    return $('#name').val();
                                },
                                id:"<?php echo ($list['denid']); ?>"
                            }
                        }
                    },
                    username:{
                        required: true,
                        remote: {
                            url: "<?php echo U('Dentist/check_user');?>",
                            type: 'post',
                            data: {
                                username: function () {
                                    return $('#username').val();
                ...
                messages: {
                    name: {
                        required : "<?php echo L('NAME_NOT_EMPTY');?>",
                        remote: "<?php echo L('CLINIC_EXISTED');?>"
                    },
                    username: {
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="<?php echo U('Dentist/edit');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo ($list["denid"]); ?>">
                                ...
                                <div class="col-sm-3">
                                    <div style="position: relative;width: 200px;display: inline-block;margin-right: 10px;" id="pic_div">
                                        <div class="form-item" style="border: 0; line-height: 52px;">
                                            <input type="hidden" id="logo" name="logo" value="<?php echo ($list["pic"]); ?>" />
                                            <div class="fl ">
                                                ...
                                                <?php if($list["pic"] != ''): ?><div style="position: relative;display: inline-block;" id="ddiv">
                                                        <img style="max-height: 120px"  src="<?php echo ($list['pic']); ?>">
                                                        <div class="pdel"><button id="bdel" type="button" style="border:0;width:20px;height:20px;display:block; background: none;"></button></div>
                                                    </div><?php endif; ?>
                                                <script>
                                                    $(function(){
                                                        var t="<?php echo ($list["pic"]); ?>";
                                                        if(t!=undefined&&t!=""){
                                                            $("#license_button").hide();
                                                            $("#bdel").click(function(){
                                                                $("#license_button").show();
                                                    ...
                                                    var restrictedUploader = new qq.FineUploader({
                                                        ...
                                                        request: {
                                                            endpoint: "<?php echo U('Info/uploadPic');?>",
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('CLINIC_NAME');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="text" name="name" id="name" class="form-control" value="<?php echo ($list['name']); ?>">
                                </div>
                            </div>
                           <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('PAY_TYPE');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <select class="form-control m-b"  name="pay_type">
										<option value="0" <?php if($list["paytype"] == 0): ?>selected<?php endif; ?> ><?php echo L('CASH_PAYMENT');?></option>
										<option value="1" <?php if($list["paytype"] == 1): ?>selected<?php endif; ?>><?php echo L('PAY_MONTHLY');?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio  radio-inline"><input type="radio" value="1" name="enabled" id="enabled1"  <?php if($list["enabled"] == 1): ?>checked<?php endif; ?> > <label for="enabled1"><?php echo L('OPEN');?></label></div>
                                    <div class="radio  radio-inline"><input type="radio" value="0" name="enabled" id="enabled2" <?php if($list["enabled"] == 0): ?>checked<?php endif; ?> > <label for="enabled2"><?php echo L('CLOSE');?></label></div>
                                </div>
                            </div>
