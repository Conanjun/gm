            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5><?php echo L('STUDIO_TASK_SJS');?></h5>
                    </div>
                                    ...
                                    <table id="tt_1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($filtered != 0): ?><a href="<?php echo U('OrderTaskSjs/index');?>" class="btn btn-default"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                ...
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <?php if(($vo["task_state"] == 0) && $vo.canupplan==1): ?><a href="javascript:void(0);"  onclick="reply(<?php echo ($vo['tastkid']); ?>,<?php echo ($vo['oid']); ?>)"  data-width="800" data-height="600" class="btn btn-primary"><?php echo L('FINISH_HANDEL');?></a><?php endif; ?>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="<?php echo U('OrderTaskSjs/confirm');?>" class="form-horizontal" id="task_form" method='post' enctype="multipart/form-data">
                                            <input type="hidden" name="id" id="oid" value="" >
                                            <input type="hidden" name="task_id" id="task_id" value="" >

                                            <div class="form-group">
                                                <label class="col-sm-2 control-label"><?php echo L('S_TASK_SJS_UPLOAD');?></label>
                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="fl ">
                                                                ...
                                                                <script>
                                                                    var restrictedUploader = new qq.FineUploader({
                                                                        ...
                                                                        request: {
                                                                            endpoint: "<?php echo U('Info/uploadFile');?>",
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.cancle').click(function () {
                if(confirm("<?php echo L('IF_CANCLE');?>")) {
