            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5><?php echo L('MESSAGE_MANAGE');?></h5>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form method="get" class="form-horizontal">
                                    <input type="hidden" name="s" value="/Dentist/Message/index"/>
                                    <table>
                                        <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <select class="form-control m-b"  name="feed_status">
                                                    ...
                                                    <?php if(is_array($feed_status)): $i = 0; $__LIST__ = $feed_status;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><option value="<?php echo ($s["d_key"]); ?>" <?php if( $_GET['feed_status']== $s['d_key']): ?>selected<?php endif; ?>><?php echo ($s["d_value"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </td>
                                            <td>
                                                ...
                                                <select class="form-control m-b"  name="feedtype">
                                                    <option value=""><?php echo L('PLEASE_SELECT');?></option>
                                                    <?php if(is_array($feed_type)): $i = 0; $__LIST__ = $feed_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><option value="<?php echo ($d["d_key"]); ?>" <?php if( $_GET['feedtype']== $d['d_key']): ?>selected<?php endif; ?>><?php echo ($d["d_value"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </td>

                                            <td>
                                                <label><?php echo L('SUBMIT_TIME');?></label>
                                                <input class="form-control" type="text"  id="start_addtime" name="start_addtime" value="<?php echo ($_GET['start_addtime']); ?>">
                                                <input class="form-control" type="text" id="end_addtime" name="end_addtime" value="<?php echo ($_GET['end_addtime']); ?>">
                                            </td>
                                            <td>
                                                <label><?php echo L('RESPOND_TIME');?></label>
                                                <input class="form-control" type="text" id="start_backtime" name="start_backtime" value="<?php echo ($_GET['start_backtime']); ?>">
                                                <input class="form-control" type="text" id="end_backtime" name="end_backtime" value="<?php echo ($_GET['end_backtime']); ?>">
                                            </td>

                                            <td>
                                                <input type="submit" class="btn btn-primary" value="<?php echo L('QUERY');?>">
                                                <?php if($filtered != 0): ?><a href="<?php echo U('Message/index');?>" class="btn btn-default"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                      ...
                      -->
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                <thead>
                                <tr>
                                    <th style="width: 120px"><?php echo L('SENDER');?> </th>
                                    <th style="width: 80px"><?php echo L('RECIPIENT');?> </span></th>
									<th style="text-align: left"><?php echo L('THEME');?> </th>
									<th style="width: 130px"><?php echo L('ADDTIME');?></th>
                                ...
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <td style="width: 120px"><?php echo ($vo['nickname']); ?></td>
                                            <td style="width: 80px"><?php echo ($vo['mname']); ?></td>
											<td style="text-align: left"><?php echo ($vo['title']); ?></td>
                                            <td style="width: 130px">
                                                <?php if($vo["addtime"] != 0): echo (date("Y-m-d H:i:s",$vo['addtime'])); endif; ?>
                                            </td>
                                            <td>
                                                <a href="<?php echo U('Message/view?id='.$vo['msg_id']);?>" class="btn btn-xs btn-primary"><?php echo L('VIEW');?></a>
                                            </td>
