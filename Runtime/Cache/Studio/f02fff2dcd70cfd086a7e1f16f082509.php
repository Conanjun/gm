            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5><?php echo L('STUDIO_TASK_SD');?></h5>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form method="get" class="form-horizontal">
                                    <input type="hidden" name="s" value="/Studio/OrderTaskSd/index"/>
                                    <table id="tt_1">
                                        <tbody>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($filtered != 0): ?><a href="<?php echo U('OrderTaskSd/index');?>" class="btn btn-default"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?php echo U('OrderTaskSd/confirm');?>" class="form-horizontal" id="task_form" method='post' enctype="multipart/form-data">
                                            <input type="hidden" name="tid" id="task_id" value="" >
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label"><?php echo L('S_TASK_TASK_SPEC');?></label>
                                                <div class="col-sm-10">
                                                    <textarea  name="finishnote" class="form-control" style="width: 400px;height: 170px;"></textarea>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
