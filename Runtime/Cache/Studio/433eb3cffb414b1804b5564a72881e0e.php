            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5><?php echo L('STUDIO_TASK_BQ');?></h5>
                    </div>
                                    ...
                                    <table id="tt_1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($filtered != 0): ?><a href="<?php echo U('OrderTaskBq/index');?>" class="btn btn-default"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?php echo U('OrderTaskBq/confirm');?>" class="form-horizontal" id="task_form" method='post' enctype="multipart/form-data">
