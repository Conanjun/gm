            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        <h5>
                            <?php echo L('STUDIO_INFO');?>
                        </h5>
                        <div class="ibox-button">
                            <a href="<?php echo U('Info/edit?id='.$list['stuid']);?>" class="btn btn-primary btn-sm" type="button"><?php echo L('EDIT');?></a>
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="" method='post' id="form" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('NAME');?><span class="required" style="vertical-align: middle"></span></label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <p class="form-control-static"><?php echo ($list['urlparam']); ?></p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('REGION');?></label>
                                <div id="region" class="col-sm-10">
                                    <p class="form-control-static"><?php echo ($list['regionname']); ?></p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('ADDR');?></label>
                                <div class="col-sm-3">
                                    <p class="form-control-static"><?php echo ($list['addr']); ?></p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('CONTACT');?></label>
                                <div class="col-sm-3">
                                    <p class="form-control-static"><?php echo ($list['contact']); ?></p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('TEL_PHONE');?></label>
                                <div class="col-sm-3">
                                    <p class="form-control-static"><?php echo ($list['tel']); ?></p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('STATE');?></label>
                                <div class="col-sm-10">
                                    <?php if($list["enabled"] == 1): ?><p class="form-control-static"><?php echo L('OPEN');?></p><?php endif; ?>
                                    <?php if($list["enabled"] == 0): ?><p class="form-control-static"><?php echo L('CLOSE');?></p><?php endif; ?>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php if($list["language"] == 'zh_cn'): ?><p class="form-control-static"><?php echo L('ZH_CN');?></p><?php endif; ?>
                                    <?php if($list["language"] == 'en_us'): ?><p class="form-control-static"><?php echo L('EN_US');?></p><?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <p class="form-control-static">    
                                        <?php if(is_array($sts)): $i = 0; $__LIST__ = $sts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i; echo ($s["name"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <p class="form-control-static"><?php echo ($list['tag']); ?></p>
                                </div>
                            </div>
                            <div class="form-group" id="studioInfoDesc">
                                <label class="col-sm-2 control-label"><?php echo L('DESCRIPTION');?></label>
                                <div class="col-sm-10">
                                    <p class="form-control-static"><?php echo ($list['description']); ?></p>
                                </div>
                            </div>
                        </form>
                    </div>
