			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<form action="<?php echo U('AuthRule/edit');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">
							<input type="hidden" name="id" value="<?php echo ($list["id"]); ?>">
							<div class="form-group">
								<label class="col-sm-2 control-label"><?php echo L('NAME');?><span class="required"></span></label>
								<div class="col-sm-3">
									<input type="text" id="title" name="title" value="<?php echo ($list['title']); ?>" class="form-control" autocomplete="off" placeholder="<?php echo L('PLATFORM_NAME_NOT_EMPTY');?>">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label"><?php echo L('DESCRIPTION');?></label>
								<div class="col-sm-4">
									<textarea id="description" name="description" class="form-control"><?php echo ($list["description"]); ?></textarea>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label"><?php echo L('ORDER');?></label>
								<div class="col-sm-3">
									<input type="text" name="sort_order" value="<?php echo ($list["sort_order"]); ?>" class="form-control" autocomplete="off" placeholder="请输入排序">
								</div>
							</div>
							<div class="form-group">
