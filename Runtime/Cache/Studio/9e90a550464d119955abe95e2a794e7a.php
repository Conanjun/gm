                    ...
                    <div class="ibox-content">
						...
						<input type="hidden" name="id" value="<?php echo ($m['id']); ?>">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="username" id="username" value="<?php echo ($m['username']); ?>" class="form-control" autocomplete="off" placeholder="<?php echo L('UNAME_NOT_EMPTY');?>">
                                </div>
                            </div>
							<div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('PASSWORD');?></label>
                                <div class="col-sm-3">
                                    <input type="password" name="password" id="password" value="<?php echo ($m['password']); ?>" class="form-control" autocomplete="off" placeholder="<?php echo L('PASSWORD_LENTH');?>">
                                </div>
                            </div>
							 <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('MNAME');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="text" name="nickname" id="nickname" id="nickname" value="<?php echo ($m['nickname']); ?>" class="form-control" autocomplete="off" placeholder="<?php echo L('NNAME_NOT_EMPTY');?>">
                                </div>
                            </div>
                                ...
                                <!--<div class="col-sm-3">-->
                                    <!--<select class="form-control m-b"  name="dept">-->
                                        ...
                                        <!--<?php if(is_array($depts)): $i = 0; $__LIST__ = $depts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?>-->
											<!--<option value="<?php echo ($r["did"]); ?>" <?php if($m['dept'] == $r['did']): ?>selected<?php endif; ?>><?php echo ($r["title_show"]); ?></option>-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="email" class="form-control" id="email" value="<?php echo ($m['email']); ?>" class="form-control" autocomplete="off"placeholder="<?php echo L('EMAIL_NOT_EMPTY');?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="radio  radio-inline"> <input type="radio" value="1" name="sex"  id="sex" <?php if($m['sex'] == 1): ?>checked<?php endif; ?>><label for="sex"> <?php echo L('MAN');?></label></div>
                                    <div class="radio  radio-inline"> <input type="radio" value="2" name="sex"  id="sex1" <?php if($m['sex'] == 2): ?>checked<?php endif; ?>> <label for="sex1"> <?php echo L('WOMAN');?> </label></div>
                                    <div class="radio  radio-inline"><input type="radio" value="0" name="sex"  id="sex2" <?php if($m['sex'] == 0): ?>checked<?php endif; ?>> <label for="sex2"><?php echo L('SECRECY');?></label> </div>
                                </div>
                            </div>
