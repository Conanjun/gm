            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5><?php echo L('STUDIO_TASK_CW');?></h5>
                    </div>
                                    ...
                                    <table id="tt_1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($filtered != 0): ?><a href="<?php echo U('OrderTaskCw/index');?>" class="btn btn-default"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                ...
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <?php if($vo["task_state"] == 0 && $vo["state"] == 60): ?><a data-trigger="modal" href="<?php echo U('OrderTaskCw/feepay?tid='.$vo['tastkid']);?>" data-width="1200" data-height="600" data-title="<?php echo L('STUDIO_TASK_CW');?>" class="btn btn-primary"><?php echo L('FINISH_HANDEL');?></a><?php endif; ?>
