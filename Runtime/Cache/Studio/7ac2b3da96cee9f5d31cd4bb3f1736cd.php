            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="<?php echo U('Dentist/add');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control m-b"  name="pay_type">
										<option value="0"><?php echo L('CASH_PAYMENT');?></option>
										<option value="1"><?php echo L('PAY_MONTHLY');?></option>
                                    </select>
                                </div>
                            </div>
