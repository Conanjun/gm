                    ...
                    <div class="ibox-content">
                        ...
                        <form action="<?php echo U('User/add');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio  radio-inline"><input type="radio" value="1" name="sex" checked="checked" id="sex1">  <label for="sex1"> <?php echo L('MAN');?> </label></div>
                                    <div class="radio  radio-inline"><input type="radio" value="2" name="sex" id="sex2"> <label for="sex2"> <?php echo L('WOMAN');?> </label></div>
									<div class="radio  radio-inline"><input type="radio" value="0" name="sex" id="sex3"> <label for="sex3"> <?php echo L('SECRECY');?> </label></div>
                                </div>
                            </div>
                            <div class="form-group">
