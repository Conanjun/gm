...
<body class="">
    ...
    <script type="text/javascript">
        var grid = 0;
        var ajaxurl = "<?php echo U('Region/ajax_col');?>";
        $(function(){
            regionInit("region");
        });
    </script>
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5><?php echo L('REGION_MAINTAIN');?></h5>
                        <div class="ibox-button">
                            <a href="<?php echo U('Region/add');?>" class="btn btn-primary btn-sm"><?php echo L('ADD');?></a>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12">
                                <form method="get" class="form-horizontal">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <label><?php echo L('REGION_NAME');?></label>
                                                <input class="form-control" type="text" name="region_name" value="<?php echo ($_GET['region_name']); ?>">
                                            </td>
                                            <td>
                                                <label><?php echo L('ORDER');?></label>
                                                <input class="form-control" type="text" name="sort_order" value="<?php echo ($_GET['sort_order']); ?>">
                                            </td>
                                            <td>
                                                <input type="submit" class="btn btn-primary" value="<?php echo L('QUERY');?>">
                                                <?php if($filtered != 0): ?><a href="<?php echo U('Region/index');?>" class="btn btn-white"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left"><span ectype="order_by" fieldname="region_name"><?php echo L('REGION_NAME');?> <i class="fa fa-sort"></i></span></span></th>
									<th style="text-align: left"><span ectype="order_by" fieldname="parent_id"><?php echo L('REGION_PNAME');?><i class="fa fa-sort"></i></span></th>
                                ...
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <input type="checkbox" name="check" value="<?php echo ($vo['region_id']); ?>" class="check">
                                               <label></label></div>
                                            </td>
                                            <td style="text-align: left"><?php echo ($vo['region_name']); ?></td>
											<td style="text-align: left"><?php echo ($vo['parent_name']); ?></td>
                                            <td><?php echo ($vo['sort_order']); ?></td>
                                            <td style="text-align: right">
                                                <a href="<?php echo U('Region/edit?id='.$vo['region_id']);?>" class="btn btn-xs btn-primary"><?php echo L('EDIT');?></a>
                                                <a data-trigger="confirm" data-content="<?php echo L('DATANDEL');?>" data-title="<?php echo L('DELTITILE');?>"
                                                data-ajax="<?php echo U('Region/deletedata?id='.$vo['region_id']);?>"
                                                data-type="get"
