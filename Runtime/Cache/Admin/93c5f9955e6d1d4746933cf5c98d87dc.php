            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="<?php echo U('AuthDefault/add');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio  radio-inline"><input type="radio" value="1" name="designer"  id="sex1">  <label for="sex1"> <?php echo L('YES');?> </label></div>
                                    <div class="radio  radio-inline"><input type="radio" value="0" name="designer" checked="checked" id="sex2"> <label for="sex2"> <?php echo L('NO');?> </label></div>
                                </div>
                            </div>
