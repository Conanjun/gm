            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="<?php echo U('AuthManager/add');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="form-group">
							 ...
							 <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="radio  radio-inline"><input type="radio" value="0" name="d_del" checked id="enabled1"><label for="enabled1"> <?php echo L('NORMAL');?></label></div>
                                    <div class="radio  radio-inline"><input type="radio" value="1" name="d_del" id="enabled2"><label for="enabled2"> <?php echo L('DISABLE');?></label></div>
                                </div>
                            </div>
                            <div class="form-group">
