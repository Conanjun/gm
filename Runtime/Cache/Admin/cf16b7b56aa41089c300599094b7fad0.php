                    ...
                    <div class="ibox-content">
                            ...
                            <div class="col-lg-12">
                                <form method="get" class="form-horizontal">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <label><?php echo L('ORDER_CNAME');?></label>
                                                <input  class="form-control" type="text" name="name" value="<?php echo ($_GET['name']); ?>">
                                            </td>
                                            <td>
                                                <label><?php echo L('C_RESHIP');?></label>
                                                <input   class="form-control" type="text" name="sname" value="<?php echo ($_GET['sname']); ?>">
                                            </td>
                                            <td>
                                                <label><?php echo L('FEED_TYPE');?></label>
                                                <select name="type" class="form-control" >
                                                    <option value=""><?php echo L('PLEASE_SELECT');?></option>
                                                    <?php if(is_array($feed_type)): $i = 0; $__LIST__ = $feed_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sl): $mod = ($i % 2 );++$i;?><option value="<?php echo ($sl["d_key"]); ?>" <?php if($_GET['type']== $sl['d_key']): ?>selected<?php endif; ?>><?php echo ($sl["d_value"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </td>
                                            <td>
                                                ...
                                                <select name="state" class="form-control" >
                                                    <option value=""><?php echo L('PLEASE_SELECT');?></option>
                                                    <?php if(is_array($feed_status)): $i = 0; $__LIST__ = $feed_status;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sl): $mod = ($i % 2 );++$i;?><option value="<?php echo ($sl["d_key"]); ?>" <?php if($_GET['state']== $sl['d_key']): ?>selected<?php endif; ?>><?php echo ($sl["d_value"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </td>
                                            
                                            <td>
                                                <label><?php echo L('FEED_TIME');?></label>
                                                <input class="form-control" style="width: 110px;"  type="text" id="addtime_from" name="addtime_from" value="<?php echo ($_GET['addtime_from']); ?>">-
                                                 <input class="form-control" style="width: 110px;"  type="text" id="addtime_to" name="addtime_to" value="<?php echo ($_GET['addtime_to']); ?>">
                                            </td>
                                            
                                             <td>
                                                <label><?php echo L('S_TIME');?></label>
                                                <input class="form-control" style="width: 110px;"  type="text" id="backtime_from" name="backtime_from" value="<?php echo ($_GET['backtime_from']); ?>">-
                                                 <input class="form-control" style="width: 110px;"  type="text" id="backtime_to" name="backtime_to" value="<?php echo ($_GET['backtime_to']); ?>">
                                            </td>
                                            
                                            <td>
                                                <input type="submit" class="btn btn-primary" value="<?php echo L('QUERY');?>">
                                                <?php if($filtered != 0): ?><a href="<?php echo U('CustomerFeed/index');?>" class="btn btn-white"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                <thead>
                                <tr>
                                    <th style="text-align: left"><span ectype="order_by" fieldname="state"><?php echo L('STATE');?><i class="fa fa-sort"></i></span></th>								
									<th style="text-align: left"><span><?php echo L('ORDER_CNAME');?></span></th>
                                    <th style="text-align: left"><span><?php echo L('C_RESHIP');?></span></th>
                                    
                                    <th style="width: 100px"><span><?php echo L('FEED_TYPE');?></span></th>
                                    <th style="text-align: left"><span><?php echo L('FEED_CONTENT');?></span></th>
									<th style="width: 150px"><span ectype="order_by" fieldname="addtime"><?php echo L('FEED_TIME');?><i class="fa fa-sort"></i></span></th>
                                    <th style="width: 100px"><span><?php echo L('FEED_P');?></span></th>
									<th style="width: 150px"><span ectype="order_by" fieldname="backtime"><?php echo L('S_TIME');?><i class="fa fa-sort"></i></span></th>
                                ...
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td style="text-align: left"><?php echo ($vo['sname']); ?></td>
                                            <td><?php echo ($vo['ftype']); ?></td>
                                            <td style="text-align: left"><?php echo ($vo['content']); ?></td>
                                            <td><?php if($vo['addtime']): echo (date("Y-m-d H:i",$vo['addtime'])); else: ?>-<?php endif; ?></td>
                                            <td><?php echo ($vo['nickname']); ?></td>
                                            <td><?php if($vo['backtime']): echo (date("Y-m-d H:i",$vo['backtime'])); else: ?>-<?php endif; ?></td>
                                             <td  style="text-align: right;">
                                                <a href="<?php echo U('CustomerFeed/view?id='.$vo['id']);?>" class="btn btn-xs btn-primary"><?php echo L('VIEW');?></a>
                                            </td>
