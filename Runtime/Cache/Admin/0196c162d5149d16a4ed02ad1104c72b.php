...
$(function(){
	$('form').validate({
	    ...
	    rules: {
	    	region_name: {
	            required: true,
	            remote: {
                    url: "<?php echo U('Region/checkname');?>",
                    type: 'GET',
                    data: {
	    ...
	    messages: {
	    	region_name: {
	    		required : "<?php echo L('REGION_NOT_EMP');?>",
	    		remote : "<?php echo L('REGION_EXT');?>",
	        },
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="<?php echo U('Region/add');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('REGION_NAME');?></label>
                                <div class="col-sm-3">
                                    <input type="text" id="region_name" name="region_name" value="" class="form-control" autocomplete="off" placeholder="<?php echo L('REGION_NOT_EMP');?>">
                                </div>
                            </div>
							<div class="form-group">
                                ...
                                <div id="region" class="col-sm-10">
                                    ...
                                    <select class="form-control" id="parent_id" name="parent_id" >
                                        ...
                                        <?php if(is_array($region)): $i = 0; $__LIST__ = $region;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["region_id"]); ?>" ><?php echo ($vo["region_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
								</div>
							 </div>
							<div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="sort_order" value="" class="form-control" autocomplete="off" placeholder="<?php echo L('ORDER_NOT_EMP');?>">
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <!-- content end -->
     ...
     <script type="text/javascript">
        //导航高亮
        highlight_subnav("<?php echo U('Region/index');?>");
    </script> 
</body>
