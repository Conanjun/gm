            ...
            $('#form').validate({
                ...
                rules: {
                    feecode: {
                        required: true,
                        remote: {
                            url: "<?php echo U('Feeitem/checkcode');?>",
                            type: 'GET',
                            data: {
                            	feecode: function () {
                                    return $('#feecode').val();
                    ...
                    feename: {
                        required: true,
                        remote: {
                            url: "<?php echo U('Feeitem/checkname');?>",
                            type: 'GET',
                            data: {
                            	feename: function () {
                                    return $('#feename').val();
                ...
                messages: {
                    feecode: {
                        required : "<?php echo L('FEE_CODE_NOT_EMPTY');?>",
                        remote: "<?php echo L('FEE_CODE_EXISTED');?>"
                    },
                    feename: {
                        required : "<?php echo L('FEE_NAME_NOT_EMPTY');?>",
                        remote: "<?php echo L('FEE_NMAE_EXISTED');?>"
                    },
                }
            });
        });
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="<?php echo U('Feeitem/add');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">

							 <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('FEE_CODE');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="text" name="feecode" id ="feecode" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('FEE_NAME');?><span class="required"></span></label>
                                <div class="col-sm-3">
