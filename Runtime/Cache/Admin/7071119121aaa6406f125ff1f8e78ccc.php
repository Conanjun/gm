...
<body class="">
    ...
    <script type="text/javascript">
        var grid = 0;
        var ajaxurl = "<?php echo U('AuthManager/ajax_col');?>";
        $(function(){
            regionInit("region");
        });
    </script>
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5><?php echo L('PLATFORM_ROLE');?></h5>
                        <div class="ibox-button">
                            <a href="<?php echo U('AuthManager/add');?>" class="btn btn-primary btn-sm"><?php echo L('ADD');?></a>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12">
                                <form method="get" class="form-horizontal">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <label><?php echo L('PLATFORM_NAME');?></label>
                                            ...
                                            <td>
                                                ...
                                                <select name="status" class="form-control" >
                                                    ...
                                                    <option value="1" <?php if($_GET['status']== 1): ?>selected<?php endif; ?>><?php echo L('NORMAL');?></option>
                                                    <option value="2" <?php if($_GET['status']== 2): ?>selected<?php endif; ?>><?php echo L('DISABLE');?> </option>
                                                </select>
                                            </td>
                                            <td>
                                                <input type="submit" class="btn btn-primary" value="<?php echo L('QUERY');?>">
                                                <?php if($filtered != 0): ?><a href="<?php echo U('AuthManager/index');?>" class="btn btn-white"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left"><span ectype="order_by" fieldname="title"><?php echo L('PLATFORM_NAME');?> <i class="fa fa-sort"></i></span></span></th>
                                   
									<th style="width: 80px"><span ectype="order_by" fieldname="status"><?php echo L('STATE');?><i class="fa fa-sort"></i></span></th>
									<th style="text-align: left"><span ectype="order_by" fieldname="description"><?php echo L('DESCRIBE');?><i class="fa fa-sort"></i></span></th>
                                    <th style="width: 200px"><?php echo L('OP');?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											...
											<td>
												<?php if($vo['status'] == 1): echo L('NORMAL');?>
												<?php elseif($vo['status'] == 0): echo L('DISABLE');?>
												<?php else: ?> <?php echo L('DELETE'); endif; ?>
											</td>
											 <td style="text-align: left"><?php echo ($vo['description']); ?></td>
                                            <td style="text-align: right">
                                            	<a href="<?php echo U('AuthManager/userlist?id='.$vo['id']);?>" class="btn btn-xs btn-primary"><?php echo L('USERLIST');?></a>
                                                <a href="<?php echo U('AuthManager/edit?id='.$vo['id']);?>" class="btn btn-xs btn-primary"><?php echo L('EDIT');?></a>
												<a href="<?php echo U('AuthManager/access',array('group_name'=>$vo['title'],'group_id'=>$vo['id']));?>" class="btn btn-xs btn-primary"><?php echo L('PURVIEW');?></a>
                                                <a data-trigger="confirm" data-content="<?php echo L('DATANDEL');?>" data-title="<?php echo L('DELTITILE');?>"
                                                data-ajax="<?php echo U('AuthManager/deletedata?id='.$vo['id']);?>"
                                                data-type="get"
    ...
    <script>
     ...
     // 多选删除
        var url = 'index.php?s=/Admin/AuthManager/deletedata';
