                    ...
                    <div class="ibox-content">
                            ...
                            <div class="col-lg-12">
                                <form method="get" class="form-horizontal">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <label><?php echo L('C_KEYS');?></label>
                                                <input style="width: 220px !important" placeholder="<?php echo L('C_KEYS_TIP');?>" class="form-control" type="text" name="keys" value="<?php echo ($_GET['keys']); ?>">
                                            </td>
                                            <td>
                                                <label><?php echo L('C_CONTACT');?></label>
                                                <input style="width: 130px !important" placeholder="<?php echo L('C_CONTACT_TIP');?>" class="form-control" type="text" name="name" value="<?php echo ($_GET['name']); ?>">
                                            </td>
                                            <td>
                                                <label><?php echo L('C_PTYPE');?></label>
                                                <select name="paytype" class="form-control" >
                                                    <option value=""><?php echo L('PLEASE_SELECT');?></option>
                                                    <?php if(is_array($plist)): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sl): $mod = ($i % 2 );++$i;?><option value="<?php echo ($sl["d_key"]); ?>" <?php if($_GET['paytype']== $sl['d_key']): ?>selected<?php endif; ?>><?php echo ($sl["d_value"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </td>
                                            <td>
                                                <label><?php echo L('C_ENABLE');?></label>
                                                <select name="enabled" class="form-control" >
                                                    <option value=""><?php echo L('PLEASE_SELECT');?></option>
                                                    <option value="1" <?php if($_GET['enabled']== 1): ?>selected<?php endif; ?>><?php echo L('yes');?></option>
                                                    <option value="0" <?php if($_GET['enabled']=== '0'): ?>selected<?php endif; ?>><?php echo L('no');?></option>
                                                </select>
                                            </td>
                                            <td>
                                                <input type="submit" class="btn btn-primary" value="<?php echo L('QUERY');?>">
                                                <?php if($filtered != 0): ?><a href="<?php echo U('PlatCustomer/index');?>" class="btn btn-white"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                <thead>
                                <tr>
                                    <th style="text-align: left"><span><?php echo L('C_NAME');?></span></th>								
									<th style="text-align: left"><span><?php echo L('C_RESHIP');?></span></th>
                                    <th style="text-align: left"><span><?php echo L('C_RE');?></span></th>
                                    
                                    <th style="width: 100px"><span><?php echo L('C_PTYPE');?></span></th>
                                    <th style="width: 100px"><span><?php echo L('C_TEL');?></span></th>
									<th style="width: 100px"><span><?php echo L('C_CONTACT');?></span></th>
									<th style="width: 130px"><span ectype="order_by" fieldname="addtime"><?php echo L('C_ADDTIME');?><i class="fa fa-sort"></i></span></th>
									<th style="width: 120px"><span ectype="order_by" fieldname="enabled"><?php echo L('C_ENABLE');?><i class="fa fa-sort"></i></span></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <?php if($vo['enabled']): ?><img src="Admin/images/positive_enabled.png"  title="<?php echo L('EDITABLE');?>"/>
                                                    <?php else: ?>
                                ...
                                <?php else: ?>
                                   <tr>
                                       <td colspan="8"><?php echo L('NOCONCENT');?></td>
                                   </tr><?php endif; ?>
