        ...
        $(function(){
            ...
            $('#form').validate({
                ...
                messages: {
                    ...
                    username:{
                   	 required: "<?php echo L('USERNAME_NOT_EMPTY');?>",
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="<?php echo U('Studio/add');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="username" id="username" value="" class="form-control" autocomplete="off" placeholder="<?php echo L('UNAMEREQUNI');?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('PASSWORD');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="password" name="password" id="password" value="" class="form-control" autocomplete="off" placeholder="<?php echo L('PASSREQUNI');?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('MNAME');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="text" name="nickname" id="nickname" id="nickname" value="" class="form-control" autocomplete="off" placeholder="<?php echo L('NAMEREQUNI');?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" id="urlparam" name="urlparam" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio  radio-inline"><input type="radio" value="1" name="enabled" checked id="enabled1"> <label for="enabled1"><?php echo L('OPEN');?></label></div>
                                    <div class="radio  radio-inline"><input type="radio" value="0" name="enabled" id="enabled2"> <label for="enabled2"><?php echo L('CLOSE');?></label></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('LANGUAGE');?></label>
                                <div class="col-sm-10">
                                    <div class="radio radio-inline"> <input type="radio" value="zh_cn" name="language" checked id="language1"> <label for="language1"><?php echo L('ZH_CN');?></label></div>
                                    <div class="radio radio-inline"> <input type="radio"  value="en_us" name="language" id="language2"> <label for="language2"><?php echo L('EN_US');?></label></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <ul class="sitem">
                                        <?php if(is_array($sts)): $i = 0; $__LIST__ = $sts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i; if($s["h"] > 0): ?><li item="<?php echo ($s["d_tid"]); ?>" item1="<?php echo ($s["d_value"]); ?>" h="1" id="sli_<?php echo ($s["d_tid"]); ?>" class="loin">
                                                <?php echo ($s["name"]); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <ul class="sitem">
                                        <?php if(is_array($tags)): $i = 0; $__LIST__ = $tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i; if($s["h"] > 0): ?><li item="<?php echo ($s["tag_id"]); ?>" item1="<?php echo ($s["tag_name"]); ?>" h="1" id="li_<?php echo ($s["tag_id"]); ?>" class="loin">
                                                <?php echo ($s["tag_name"]); ?>
