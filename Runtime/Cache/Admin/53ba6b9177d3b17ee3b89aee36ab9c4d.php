...
<body class="">
	...
	<script src="Admin/js/in/echarts.min.js"></script>
	<style>
		.flot-chart{
			height: 300px;
		}
		...
		<div class="row">
			<div class="col-lg-4">
				...
				<div class="ibox">
					...
					<div class="ibox-content">
						<h1 class="no-margins"><?php echo ($studio_num); ?></h1>
			...
			<div class="col-lg-4">
				...
				<div class="ibox">
					...
					<div class="ibox-content">
						<h1 class="no-margins"><?php echo ($client_num); ?></h1>
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="ibox">
					...
					<div class="ibox-title">
						<h5><?php echo L('STUDIO_CHANGE');?></h5>
						<div class="ibox-tools">
							<a class="collapse-link">
								<i class="fa fa-chevron-up"></i>
							</a>
			...
			<div class="col-lg-6">
				<div class="ibox">
					...
					<div class="ibox-title">
						<h5><?php echo L('CLIENT_CHANGE');?></h5>
						<div class="ibox-tools">
							<a class="collapse-link">
								<i class="fa fa-chevron-up"></i>
							</a>
