            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="<?php echo U('Dictionary/add');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('CODE');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="text" name="d_code" value="" class="form-control" autocomplete="off" placeholder="<?php echo L('INPUT_DCODE_NOT');?>">
                                </div>
                            </div>
							<div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('DKEY');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="text" name="d_key" value="" class="form-control" autocomplete="off" placeholder="<?php echo L('INPUT_DKEY_NOT');?>">
                                </div>
                            </div>
							<div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('DVALUE');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="text" name="d_value" value="" class="form-control" autocomplete="off" placeholder="<?php echo L('INPUT_DVALUE_NOT');?>">
                                </div>
                            </div>
							
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('DORDER');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="text" name="d_order" value="" class="form-control" autocomplete="off">
                                </div>
                            </div>
							<div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('NAME');?></label>
                                <div class="col-sm-3">
                                    <input type="text" name="d_name" id="d_name" value="" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('STATE');?></label>
                                <div class="col-sm-3">
                                    <div class="radio  radio-inline"><input type="radio" value="0" name="status" checked id="enabled1"><label for="enabled1"> <?php echo L('NORMAL');?></label></div>
                                    <div class="radio  radio-inline"><input type="radio" value="1" name="status" id="enabled2"><label for="enabled2"> <?php echo L('DISABLE');?></label></div>
                                </div>
                            </div>
                            <div class="form-group">
