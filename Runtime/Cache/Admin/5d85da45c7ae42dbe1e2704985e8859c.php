...
<body class="">
    ...
    <script type="text/javascript">
        var grid = 0;
        var ajaxurl = "<?php echo U('User/ajax_col');?>";
        $(function(){
            regionInit("region");
        });
    </script>
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5><?php echo L('PLATFORM_USER');?></h5>
                        <div class="ibox-button">
                            <a href="<?php echo U('User/add');?>" class="btn btn-primary btn-sm"><?php echo L('ADD');?></a>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12">
                                <form method="get" class="form-horizontal">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <label><?php echo L('MNAME');?></label>
                                                <input class="form-control w-100" type="text" name="mname" value="<?php echo ($_GET['mname']); ?>">
                                            </td>
                                            <td style="display: none">
                                                <label><?php echo L('DNAME');?></label>
                                                <input class="form-control w-100" type="text" name="dname" value="<?php echo ($_GET['dname']); ?>">
                                            </td>
											 
											<td>
                                                <label><?php echo L('EMAIL');?></label>
                                                <input class="form-control w-100" type="text" name="email" value="<?php echo ($_GET['email']); ?>">
                                            </td>
											<td>
                                                <label><?php echo L('UNAME');?></label>
                                                <input class="form-control w-100" type="text" name="uname" value="<?php echo ($_GET['uname']); ?>">
                                            </td>
                                            <td>
                                                <label><?php echo L('MOBILE');?></label>
                                                <input class="form-control w-100" type="text" name="mobile" value="<?php echo ($_GET['mobile']); ?>">
                                            </td>
                                            <td>
                                                <label><?php echo L('ROLE_NAME');?></label>
                                                 <select name="role_name" class="form-control m-b">
                                                    <option value=""><?php echo L('PLEASE_SELECT');?></option>
													
                                                    <?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><option value="<?php echo ($r["id"]); ?>" <?php if( $_GET['role_name']== $r['id']): ?>selected<?php endif; ?> ><?php echo ($r["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </td>
                                            <td>
                                                ...
                                                <select name="status" class="form-control m-b">
                                                    <option value=""><?php echo L('PLEASE_SELECT');?></option>
                                                    <option value="1" <?php if($_GET['status']== 1): ?>selected<?php endif; ?>><?php echo L('OPEN');?></option>
                                                    <option value="2" <?php if($_GET['status']== 2): ?>selected<?php endif; ?>><?php echo L('CLOSE');?> </option>
                                                </select>
                                            </td>
                                            <td>
                                                <input type="submit" class="btn btn-primary" value="<?php echo L('QUERY');?>">
                                                <?php if($filtered != 0): ?><a href="<?php echo U('User/index');?>" class="btn btn-white"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left;width: 120px"><span ectype="order_by" fieldname="nickname"><?php echo L('MNAME');?> <i class="fa fa-sort"></i></span></span></th>
                                    <!--  <th><span ectype="order_by" fieldname="d.name"><?php echo L('DNAME');?> <i class="fa fa-sort"></i></span></span></th>-->
                                    <th style="text-align: left;"><span ectype="order_by" fieldname="ag.title"><?php echo L('ROLE_NAME');?><i class="fa fa-sort"></i></span></span></th>
                                    <th style="text-align: left;"><span ectype="order_by" fieldname="um.email"><?php echo L('email');?><i class="fa fa-sort"></i></span></th>
									<th style="width: 120px"><span ectype="order_by" fieldname="um.username"><?php echo L('UNAME');?><i class="fa fa-sort"></i></span></th>
                                    <th style="width: 120px"><span ectype="order_by" fieldname="um.mobile"><?php echo L('MOBILE');?><i class="fa fa-sort"></i></span></th>
                                    <th style="width: 80px"><span ectype="order_by" fieldname="status"><?php echo L('STATE');?> <i class="fa fa-sort"></i></span></th>
									<th style="width: 170px"><span ectype="order_by" fieldname="um.reg_time"><?php echo L('REG_TIME');?> <i class="fa fa-sort"></i></span></th>
                                ...
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <td>
                                               <div class="checkbox checkbox-success">
                                                    <input type="checkbox" name="check" value="<?php echo ($vo['uid']); ?>" class="check"><label></label></div>
                                            </td>
                                            ...
                                            <td>
                                                <?php if($vo['status']): ?><img src="Admin/images/positive_enabled.png" ectype="inline_edit" fieldname="status" fieldid="<?php echo ($vo["uid"]); ?>" fieldvalue="1" title="<?php echo L('EDITABLE');?>"/>
                                                    <?php else: ?>
                                                    <img src="Admin/images/positive_disabled.png" ectype="inline_edit" fieldname="status" fieldid="<?php echo ($vo["uid"]); ?>" fieldvalue="0" title="<?php echo L('EDITABLE');?>"/><?php endif; ?>
                                            </td>
											<td><?php echo (date("Y-m-d H:i:s",$vo['reg_time'])); ?></td>
                                            <td style="text-align: RIGHT;">
                                                <a href="<?php echo U('User/edit?id='.$vo['uid']);?>" class="btn btn-xs btn-primary"><?php echo L('EDIT');?></a>
                                                <a data-trigger="confirm" data-content="<?php echo L('DATANDEL');?>" data-title="<?php echo L('DELTITILE');?>"
                                                data-ajax="<?php echo U('User/delete?id='.$vo['uid']);?>"
                                                data-type="get"
    ...
    <script>
        $(document).ready(function(){
         ...
         // 多选删除
            var url = 'index.php?s=/Admin/User/delete';
