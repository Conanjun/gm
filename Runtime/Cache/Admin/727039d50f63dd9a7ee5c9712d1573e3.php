...
<body class="">
    ...
    <script type="text/javascript">
        var ajaxurl = "<?php echo U('Payment/ajax_col');?>";
    </script>
    <!-- content begin -->
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                <thead>
                                <tr>
                                    <th style="width: 200px;text-align: left"><?php echo L('PAYMENT_METHOD_NAME');?> </th>
                                    <th style="width: 80px;text-align: left"><?php echo L('STATE');?></th>
                                    <th></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <td style="text-align: left;padding-left: 10px"><?php echo L($vo['name']);?></td>
                                            <td style="text-align: left">
                                                <?php if($vo['enabled']): ?><img src="Admin/images/positive_enabled.png" ectype="inline_edit" fieldname="enabled" fieldid="<?php echo ($vo["payid"]); ?>" fieldvalue="1" title="<?php echo L('EDITABLE');?>"/>
                                                    <?php else: ?>
                                                    <img src="Admin/images/positive_disabled.png" ectype="inline_edit" fieldname="enabled" fieldid="<?php echo ($vo["payid"]); ?>" fieldvalue="0" title="<?php echo L('EDITABLE');?>"/><?php endif; ?>
                                            </td>
                                            <td></td>
