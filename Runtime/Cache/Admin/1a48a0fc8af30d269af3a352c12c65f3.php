...
<body class="">
    ...
    <script type="text/javascript">
        var grid = 0;
        var ajaxurl = "<?php echo U('Feeitem/ajax_col');?>";
        $(function(){
            regionInit("region");
        });
    </script>
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5><?php echo L('FEEITEM');?></h5>
                        <div class="ibox-button">
                            <a href="<?php echo U('Feeitem/add');?>" class="btn btn-primary btn-sm"><?php echo L('ADD');?></a>
                        </div>
                    </div>
                                ...
                                <form method="get" class="form-horizontal">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label><?php echo L('FEE_CODE');?></label>
                                            ...
                                            <td>
                                                ...
                                                <?php if($filtered != 0): ?><a href="<?php echo U('Feeitem/index');?>" class="btn btn-white"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 80px;text-align: left"><?php echo L('FEE_CODE');?> </th>
                                    <th style="text-align: left"><?php echo L('FEE_NAME');?> </span></th>
                                    <th style="width: 140px"><?php echo L('ADD_TIME');?></th>
                                    <th style="width: 100px"><?php echo L('ADD_USER');?></th>
                                ...
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <td>
                                            <?php if($vo["isprive"] != 1): ?><div class="checkbox checkbox-success">
                                                    <input type="checkbox" name="check" value="<?php echo ($vo['itemid']); ?>" class="check"><label></label>
                                                </div><?php endif; ?>
                                            </td>
                                            <td style="text-align: left"><?php echo ($vo['feecode']); ?></td>
                                            <td style="text-align: left"><?php echo ($vo['feename']); ?></td>
                                            <td><?php echo (date("Y-m-d H:i",$vo['addtime'])); ?></td>
                                            <td><?php echo ($vo['nickname']); ?></td>
                                            <td style="text-align: right">
                                            <?php if($vo["isprive"] != 1): ?><a href="<?php echo U('Feeitem/edit?id='.$vo['itemid']);?>" class="btn btn-xs btn-primary"><?php echo L('EDIT');?></a>
                                                <a data-trigger="confirm" data-content="<?php echo L('DATANDEL');?>" data-title="<?php echo L('DELTITILE');?>"
                                                data-ajax="<?php echo U('Feeitem/delete?id='.$vo['itemid']);?>"
                                                data-type="get"
    ...
    <script>
        $(document).ready(function(){
            ...
            // 多选删除
            var url = 'index.php?s=/Admin/Feeitem/delete';
