            ...
            $('form').validate({
                ...
                rules: {
                    title: {
                        required: true,
                        remote: {
                            url: "<?php echo U('AuthDefault/check_title');?>",
                            type: 'post',
                            data: {
                                title: function () {
                                    return $('#title').val();
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="<?php echo U('AuthDefault/edit');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo ($list["id"]); ?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('NAME');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="text" name="title" id="title" value="<?php echo ($list["title"]); ?>" class="form-control" autocomplete="off" placeholder="<?php echo L('PLATFORM_NAME_NOT_EMPTY');?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('DESIGNER');?></label>
                                <div class="col-sm-10">
                                    <div class="radio radio-inline"><input type="radio" value="1" name="designer" id="sex1" <?php if($list['designer'] == 1): ?>checked<?php endif; ?>><label for="sex1"> <?php echo L('YES');?> </label></div>
                                    <div class="radio radio-inline"><input type="radio" value="0" name="designer" id="sex2" <?php if($list['designer'] == 0): ?>checked<?php endif; ?>> <label for="sex2"> <?php echo L('NO');?> </label></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('ORDER');?></label>
                                <div class="col-sm-3">
                                    <input type="text" name="sort_order" value="<?php echo ($list["sort_order"]); ?>" class="form-control" autocomplete="off">
                                </div>
                            </div>
