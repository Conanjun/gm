...
<body class="">
    ...
    <script type="text/javascript">
        var grid = 0;
        var ajaxurl = "<?php echo U('Tag/ajax_col');?>";
    </script>
    <!-- content begin -->
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5><?php echo L('TAG_LIBRARY');?></h5>
                        <div class="ibox-button">
                            <a href="<?php echo U('Tag/add');?>" class="btn btn-primary btn-sm"><?php echo L('ADD');?></a>
                        </div>
                    </div>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <input class="form-control" type="text" name="tag_name" value="<?php echo ($_GET['tag_name']); ?>">
                                            </td>
                                            <td>
                                                <label><?php echo L('TYPE');?></label>
                                                    ...
                                                    <select class="form-control m-b"  name="tag_type">
                                                        ...
                                                        <?php if(is_array($sts)): $i = 0; $__LIST__ = $sts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><option value="<?php echo ($s["d_key"]); ?>"  <?php if($_GET['tag_type']== $s['d_key']): ?>selected<?php endif; ?>><?php echo (l($s["d_value"])); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                            </td>
                                            <td>
                                                <input type="submit" class="btn btn-primary" value="<?php echo L('QUERY');?>">
                                                <?php if($filtered != 0): ?><a href="<?php echo U('Tag/index');?>" class="btn btn-white"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left"><span ectype="order_by" fieldname="tag_name"><?php echo L('NAME');?> <i class="fa fa-sort"></i></span></span></th>
									<th style="text-align: left"><span ectype="order_by" fieldname="tag_type"><?php echo L('TYPE');?><i class="fa fa-sort"></i></span></th>
                                ...
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <td>
                                                <div class="checkbox checkbox-success">
                                                    <input type="checkbox" name="check" value="<?php echo ($vo['tag_id']); ?>" class="check"><label></label></div>
                                            </td>
                                            <td style="text-align: left"><?php echo ($vo['tag_name']); ?></td>
                                            <td style="text-align: left"><?php echo (l($vo['d_value'])); ?></td>
                                            <td style="text-align: right">
                                                <a href="<?php echo U('Tag/edit?id='.$vo['tag_id']);?>" class="btn btn-xs btn-primary"><?php echo L('EDIT');?></a>
                                                <a data-trigger="confirm" data-content="<?php echo L('DATANDEL');?>" data-title="<?php echo L('DELTITILE');?>"
                                                data-ajax="<?php echo U('Tag/deletedata?id='.$vo['tag_id']);?>"
                                                data-type="get"
