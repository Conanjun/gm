...
$(function(){
     ...
     $('.ibox-form').on('click', '.fa-times', function(){
    	 ...
    	 var subthis=this;
    	 if(group_id&&uid){
    		 var url="<?php echo U('AuthManager/deleteacc');?>"+"&id="+group_id+"&uid="+uid;
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        <h5>
                            <?php echo L('PLATFORM_ROLE');?>-<?php echo ($group["title"]); ?>
					...
					<form action="<?php echo U('AuthManager/userlist');?>" method='post' id="form">
