...
<body class="">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-button">
                            <a href="<?php echo U('AuthDefault/add');?>" class="btn btn-primary btn-sm"><?php echo L('ADD');?></a>
                        </div>
                    </div>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($filtered != 0): ?><a href="<?php echo U('AuthDefault/index');?>" class="btn btn-white"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <table class="table table-center">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left"><span ectype="order_by" fieldname="title"><?php echo L('NAME');?> <i class="fa fa-sort"></i></span></span></th>
									 <th style="text-align: left"><span ectype="order_by" fieldname="fromadmin"><?php echo L('DESIGNER');?> <i class="fa fa-sort"></i></span></span></th>
									<th style="text-align: left"><span ectype="order_by" fieldname="sort_order"><?php echo L('ORDER');?><i class="fa fa-sort"></i></span></th>
                                ...
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td style="text-align: left"><?php if($vo['designer'] == 1): echo L('YES');?> <?php else: ?> <?php echo L('NO'); endif; ?></td>
                                            <td style="text-align: left"><?php echo ($vo['sort_order']); ?></td>
                                            <td style="text-align: right">
                                                <a href="<?php echo U('AuthDefault/edit?id='.$vo['id']);?>" class="btn btn-xs btn-primary"><?php echo L('EDIT');?></a>
                                                <a data-trigger="confirm" data-content="<?php echo L('DATANDEL');?>" data-title="<?php echo L('DELTITILE');?>"
                                                data-ajax="<?php echo U('AuthDefault/delete?id='.$vo['id']);?>"
                                                data-type="get"
                                ...
                                <?php else: ?>
                                   <tr>
                                       <td colspan="4"><?php echo L('NOCONCENT');?></td>
                                   </tr><?php endif; ?>
    ...
    <script>
        $(document).ready(function(){
            ...
            // 多选删除
            var url = 'index.php?s=/Admin/AuthDefault/delete';
