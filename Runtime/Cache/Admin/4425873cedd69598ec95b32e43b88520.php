            ...
            $('#form').validate({
                ...
                rules: {
                    name: {
                        required: true,
                        remote: {
                            url: "<?php echo U('Studio/check_name');?>",
                            type: 'post',
                            data: {
                                name: function () {
                                    return $('#name').val();
                                },
                                id:"<?php echo ($list['stuid']); ?>"
                            }
                        }
                    },
                    urlparam: {
                        remote: {
                            url: "<?php echo U('Studio/check_url');?>",
                            type: 'post',
                            data: {
                                urlparam: function () {
                                    return $('#urlparam').val();
                    ...
                    username:{
                        required: true,
                        remote: {
                            url: "<?php echo U('Studio/check_user');?>",
                            type: 'post',
                            data: {
                                username: function () {
                                    return $('#username').val();
                ...
                messages: {
                    name: {
                        required : "<?php echo L('UNITNAMEREQ');?>",
                        remote: "<?php echo L('NAME_EXISTED');?>"
                    },
                    urlparam: {
                        remote: "<?php echo L('URL_EXISTED');?>"
                    },
                    username:{
                        required: "<?php echo L('NAMEREQ');?>",
                        remote: "<?php echo L('UNAMEEX');?>"
                    },
                    password: {
                    ...
                    nickname:{
                        required: "<?php echo L('NICKNAMEREQ');?>",
                    }
                }
            });
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="<?php echo U('Studio/edit');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo ($list["stuid"]); ?>">
                                ...
                                <div class="col-sm-10">
                                    <div style="position: relative;width: 200px;display: inline-block;margin-right: 10px;" id="pic_div">
                                        <div class="form-item" style="border: 0; line-height: 52px;">
                                            <input type="hidden" id="logo" name="logo" value="<?php echo ($list["logo"]); ?>" />
                                            <div class="fl ">
                                                ...
                                                <?php if($list["logo"] != ''): ?><div style="position: relative;display: inline-block;" id="ddiv">
                                                        <img style="max-height: 120px"  src="<?php echo ($list['logo']); ?>">
                                                ...
                                                <script>
                                                    ...
                                                    var restrictedUploader = new qq.FineUploader({
                                                        ...
                                                        request: {
                                                            endpoint: "<?php echo U('Studio/uploadPic');?>",
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('UNAME');?></label>
                                <div class="col-sm-3">
                                    <input type="text" id="username" value="<?php echo ($user["username"]); ?>" class="form-control" autocomplete="off" readonly="readonly" disabled="disabled">
                                </div>
                            </div>
							<div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('PASSWORD');?></label>
                                <div class="col-sm-3">
                                    <input type="password" name="password" id="password" value="" class="form-control" autocomplete="off" placeholder="<?php echo L('PWDEMPTIP');?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('MNAME');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="text" name="nickname" id="nickname" id="nickname" value="<?php echo ($user["nickname"]); ?>" class="form-control" autocomplete="off" placeholder="<?php echo L('NAMEREQUNI');?>">
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('UNITNAME');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="text" name="name" id="name" class="form-control" value="<?php echo ($list['name']); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('URLPARAM');?></label>
                                <div class="col-sm-3">
                                    <input type="text" id="urlparam" name="urlparam" class="form-control" value="<?php echo ($list['urlparam']); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div id="region" class="col-sm-10">
                                    ...
                                    <?php if($list.regionid): ?><script>
                                            grid=<?php echo ($list["regionid"]); ?>;
                                        </script><?php endif; ?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="addr" class="form-control" value="<?php echo ($list['addr']); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('CONTACT');?></label>
                                <div class="col-sm-3">
                                    <input type="text" name="contact" class="form-control" value="<?php echo ($list['contact']); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('TEL_PHONE');?></label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio  radio-inline"><input type="radio" value="1" name="enabled" <?php if($list["enabled"] == 1): ?>checked<?php endif; ?>>  <label> <?php echo L('OPEN');?> </label></div>
                                    <div class="radio  radio-inline"><input type="radio" value="0" name="enabled" <?php if($list["enabled"] == 0): ?>checked<?php endif; ?>> <label> <?php echo L('CLOSE');?> </label></div>
                                </div>
                                
                                
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('LANGUAGE');?></label>
                                <div class="col-sm-10">
                                    <div class="radio  radio-inline"><input type="radio" value="zh_cn" name="language" <?php if($list["language"] == 'zh_cn'): ?>checked<?php endif; ?>>  <label> <?php echo L('ZH_CN');?> </label></div>
                                    <div class="radio  radio-inline"><input type="radio"  value="en_us" name="language" <?php if($list["language"] == 'en_us'): ?>checked<?php endif; ?>> <label> <?php echo L('EN_US');?> </label></div>
                                </div>
                            </div>
                            
                             <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('PROVIDES');?></label>
                                <div class="col-sm-10">
                                    <ul class="sitem">
                                        <?php if(is_array($sts)): $i = 0; $__LIST__ = $sts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i; if($s["h"] != 0): ?><li item="<?php echo ($s["d_tid"]); ?>" item1="<?php echo ($s["d_value"]); ?>" h="1" id="sli_<?php echo ($s["d_tid"]); ?>" class="lion">
                                                <?php echo ($s["name"]); ?>
                                                <input type="hidden"  name="ps[<?php echo ($s["d_tid"]); ?>]" value="<?php echo ($s["d_value"]); ?>" id="sss_<?php echo ($s["d_tid"]); ?>">
                                                </li>
                                            <?php else: ?>
                                                <li item="<?php echo ($s["d_tid"]); ?>" item1="<?php echo ($s["d_value"]); ?>" h="0" id="sli_<?php echo ($s["d_tid"]); ?>">
                                                    <?php echo ($s["name"]); ?>
                                                    <input type="hidden"  name="ps[<?php echo ($s["d_tid"]); ?>]"  id="sss_<?php echo ($s["d_tid"]); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <ul class="sitem">
                                        <?php if(is_array($tags)): $i = 0; $__LIST__ = $tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i; if($s["h"] != 0): ?><li item="<?php echo ($s["tag_id"]); ?>" item1="<?php echo ($s["tag_name"]); ?>" h="1" id="li_<?php echo ($s["tag_id"]); ?>" class="lion">
                                                    <?php echo ($s["tag_name"]); ?>
                                                    <input type="hidden"  name="tags[<?php echo ($s["tag_id"]); ?>]" value="<?php echo ($s["tag_name"]); ?>" id="ss_<?php echo ($s["tag_id"]); ?>">
                                                </li>
                                            <?php else: ?>
                                                <li item="<?php echo ($s["tag_id"]); ?>" item1="<?php echo ($s["tag_name"]); ?>" h="0" id="li_<?php echo ($s["tag_id"]); ?>">
                                                    <?php echo ($s["tag_name"]); ?>
                                                    <input type="hidden" name="tags[<?php echo ($s["tag_id"]); ?>]" id="ss_<?php echo ($s["tag_id"]); ?>">
                                                </li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                        <div class="clear"></div>
                                    </ul>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="description" name="description" style="width: 400px;height: 170px;" class="ckeditor"><?php echo ($list["description"]); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
