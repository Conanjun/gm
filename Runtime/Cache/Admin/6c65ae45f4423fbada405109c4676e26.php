            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="<?php echo U('Tag/edit');?>" method='post' id="form" class="form-horizontal" enctype="multipart/form-data">
						<input type="hidden" name="id" value="<?php echo ($list["tag_id"]); ?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo L('NAME');?><span class="required"></span></label>
                                <div class="col-sm-3">
                                    <input type="text" name="tag_name" value="<?php echo ($list['tag_name']); ?>" class="form-control" autocomplete="off" placeholder="<?php echo L('TAGNAME_NOT_EMPTY');?>">
                                </div>
                            </div>
							<div class="form-group">
                                ...
                                <div class="col-sm-3">
                                	<select class="form-control m-b"  name="tag_type">
                                        ...
                                        <?php if(is_array($sts)): $i = 0; $__LIST__ = $sts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><option value="<?php echo ($s["d_key"]); ?>"  <?php if($list['tag_type'] == $s['d_key']): ?>selected<?php endif; ?>><?php echo (l($s["d_value"])); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
