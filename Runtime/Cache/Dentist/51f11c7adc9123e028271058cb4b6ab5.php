                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-button">
                            <a data-trigger="modal" data-title="<?php echo L('ADD');?>-<?php echo L('P_SELECT_SERVICE');?>" data-width="1100px" href="<?php echo U('Order/service_select');?>" class="btn btn-primary btn-sm"><?php echo L('ADD');?></a>
                        </div>
                    </div>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($filtered != 0): ?><a href="<?php echo U('Order/index');?>" class="btn btn-white"><?php echo L('BACKOUT');?></a><?php endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 300px;"><?php echo L('HANDLE');?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td style="text-align: right;">
                                                <a href="<?php echo U('Order/view?id='.$vo['order_id']);?>" class="btn btn-xs btn-primary confirm ajax-get"><?php echo L('VIEW');?></a>
                                            </td>
