    ...
    <div class="wrapper wrapper-content">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <h1 class="no-margins"><?php echo ($pnum); ?></h1>
                        <small><?php echo L('PatientNum');?></small>
                    </div>
                </div>
                <!-- ibox end -->
            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5><?php echo L('OrderTodayNum');?></h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
                    ...
                    <div class="ibox-content">
                        <h1 class="no-margins"><?php echo ($otnum); ?></h1>
                        <small><?php echo L('OrderTodayNum');?></small>
                    </div>
                </div>
                <!-- ibox end -->
            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <h1 class="no-margins"><?php echo ($omnum); ?></h1>
                        <small><?php echo L('OrderMNum');?></small>
                    </div>
                </div>
                <!-- ibox end -->
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="ibox">
                    ...
                    <div class="ibox-title">
                        <h5><?php echo L('OrderChangeNum');?></h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
