...
<body class="">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-button">
                            <a href="<?php echo U('Feedback/add');?>" class="btn btn-primary btn-sm"><?php echo L('ADD');?></a>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left"><?php echo L('STUDIO');?> </span></th>
									<th style="text-align: left"><?php echo L('FEED_TYPE');?> </th>
									<th style="text-align: left"><?php echo L('FEED_CONTENT');?></th>
                                    <th style="width: 100px"><?php echo L('SUBMIT_TIME');?></th>
                                    <th style="width: 100px"><?php echo L('SUBMIT_USER');?></th>
                                    <th style="width: 100px"><?php echo L('RESPOND_TIME');?></th>
                                ...
                                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <td>
                                               <div class="checkbox checkbox-success">
                                                    <input type="checkbox" name="check" value="<?php echo ($vo['id']); ?>" class="check"><label></label>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo U('Feedback/delete?id='.$vo['id']);?>" class="btn btn-xs btn-default confirm ajax-get"><?php echo L('DELETE');?></a>
                                            </td>
    ...
    <script>
        $(document).ready(function(){
            ...
            // 多选删除
            var url = 'index.php?s=/Dentist/Feedback/delete';
